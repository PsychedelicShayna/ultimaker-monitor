...
// Slots used by an old version of this program, used for reference.

// protected slots:
//    // Requests authorization from the printer.
//
//     /* Connected to the stateChanged signal from the polling toggle checkbox.
//      * updates the internal atomic toggle to represent the state of the GUI toggle
//      * when the GUI toggle changes. */
//    // void updatePollingToggle(int new_toggle_state);
//
//    /* Slot connected to the connect button's clicked signal.
//     * Responsible for changing the IPV4 address stored in
//     * the printerIpv4Address atomic, and triggers a GUI
//     * refresh asynchronously. */
//    // void updatePrinterAddress();
//
//    // Set the LED lights of the printer to the values specified by the sliders.
//    // void setLedLights();
//
//    // Sets the LED light values to the values received from the printer.
//    // void reloadLedLights();
//
//    // Adds the values of the sliders to the group boxes that they inhabit.
//    // void updateLedGroupBoxes(int);
//
//    // void requestAuthorization();
//
//    // void selectFilePrompt();
//
//    // void expandPrintHistory();
//
//    /* Updates all of the relevant GUI widgets with the printer
//     * state information stored within the PrinterState instance
//     * pointed to by printer_sta  te. */
